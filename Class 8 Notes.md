...
Here are some of the scripts that are going to be used during class (use the updated HTML Boilerplate files from Class 7). Though most of the code is already in the PDF, I am reattaching them here for better formatting.:
...
### Converting the Ajax code to use OOP (Class)
```
